...
const Hero = () => {
    return(
        <>
        <Box bgImage='/hero-bg.png' backgroundSize='1376px' backgroundRepeat='no-repeat' />

        <Box pt='25px' pl='120px' pr='32px' > 
            <Flex direction='row' alignItems='center'>
                <Stack direction='row' alignItems='center'>
                    <Image ml='8px' src="/logo.png" width='46px' height='46px' alt=""></Image>
                    <Text fontSize='24px' fontWeight='500'>Agency</Text>
                </Stack>
                <Stack direction='row' spacing='32px' ml='64px'>
                ...
                <Stack direction='row' alignItems='center' ml='120px' spacing='28px'>
